...
import 'package:endeavors/screens/case_manager/profile/presentation/widgets/employement_goals_widget.dart';
import 'package:endeavors/screens/case_manager/profile/presentation/widgets/profile_emloyement_condition.dart';
...
class ClientProfilePages extends StatefulWidget {
  const ClientProfilePages({super.key});

  @override
  State<ClientProfilePages> createState() => _ClientProfilePagesState();
}

class _ClientProfilePagesState extends State<ClientProfilePages> {
  @override
  void initState() {
    context.read<ClientProfileBloc>().add(LoadedClientConditionsData());
                    ...
                    child: SingleChildScrollView(
                      ...
                      Stack(
                        children: [
                            ...
                            children: [
                              ...
                              BlocBuilder<ClientProfileBloc, ClientProfileState>(
                                builder: (context, state) {
                                  log("State ${state}");
                                  if (state is ClientConditionsLoading) {
                                    return Center(
                                      child: CircularProgressIndicator(),
                                    );
                                  } else if (state is ClientConditionsLoaded) {
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            context.read<ClientProfileBloc>().add(
                                                ToggleClientConditionsExpansion());
                                          },
                                          child: Row(
                                            mainAxisAlignment:
                                                ...
                                                itemBuilder: (context, index) {
                                                  return Padding(
                                                    ...
                                                    child: EmploymentGoalsWidget(
                                                      ...
                                                      onTap: (){
                                                        context.read<ClientProfileBloc>().add(ToggleClientGoalsExpand(index));
                                                      },
                                                    ),
                                                  );
                                                }):const SizedBox.shrink()),
                          ...
                          Positioned(
                            top: width>=600?constraintsHeight * 0.14:constraintsHeight * 0.12,
