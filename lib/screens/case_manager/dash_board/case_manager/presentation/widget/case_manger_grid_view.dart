...
class CaseManagerGridView extends StatelessWidget {
  List<CaseManagerPersonModel> dashBoardPersonModel;
   CaseManagerGridView({super.key,required this.dashBoardPersonModel});
  ...
  Widget personCard(CaseManagerPersonModel person){
    return
      Container(
