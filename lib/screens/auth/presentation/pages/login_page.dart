      ...
      builder: (context,state){
        ...
        return SafeArea(
          child:Scaffold(
            ...
            resizeToAvoidBottomInset: true, // Allows content to adjust when keyboard shows
            body: Stack(
              children: [
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        if (emailController.text.isEmpty && passwordController.text.isEmpty) {
                                          return showCustomToast(context, "Please enter email and password!", ToastType.warning);
                                        } else if (emailController.text.isEmpty) {
                                          return showCustomToast(context, "Please enter email!", ToastType.warning);
                                        } else if (passwordController.text.isEmpty) {
                                          return showCustomToast(context, "Please enter password!", ToastType.warning);
                                        } else {
                                      ...
                                      child: AnimatedContainer(
                                        ...
                                        padding: EdgeInsets.all(isLoading ? 10.sp : 19.sp),
                                        decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(10.h),
                                          color: AppColors.colD6E7,
                                          gradient: LinearGradient(
                                            colors: [Color(0xff375DFB), Color(0xff375DFB)],
